...
public class EnemySpawnController : MonoBehaviour
{
    ...
    [SerializeField] private float _waitTimeBetweenWaves;
    ...
    {
        while(_currentWaveIndex < _wavesData.Waves.Length && GameManager.Instance.CurrentGameState == GameManager.GameState.Playing)
        {
